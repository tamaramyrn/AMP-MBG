...
function RegisterAnggotaPage() {
  ...
  return (
    <AuthLayout>
      <div className="mb-8">
        <h1 className="h2 text-general-100 mb-2">Daftar Anggota AMP MBG</h1>
      ...
      <form className="space-y-5">
        ...
        <fieldset className="border border-general-30 rounded-lg px-3 pb-3 pt-1 focus-within:border-green-100 focus-within:ring-1 focus-within:ring-green-100 transition-all">
          <legend className="body-xs text-general-60 px-1 font-medium">Organisasi/Peran</legend>
          <select className="w-full outline-none text-general-100 bg-transparent body-sm">
